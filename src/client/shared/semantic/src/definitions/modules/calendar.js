// https://cdn.rawgit.com/mdehoog/Semantic-UI/6e6d051d47b598ebab05857545f242caf2b4b48c/dist/semantic.js
/*
        ...
        $allModules
            .each(function () {
                var
                    ...
                    $module = $(this),
                    $input = $module.find(selector.input).first(),
                ...
                module = {
                    ...
                    setup: {
                        ...
                        inline: function () {
                            ...
                            $container = $('<div/>').addClass(className.calendar).insertAfter($module.children().first());
                            if (!$input.length) {
                                $container.attr('tabindex', '0');
                            }
                        },
